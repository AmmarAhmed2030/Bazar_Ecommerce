      ...
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl text-slate-800 dark:text-slate-50">
        <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12 text-slate-800 dark:text-slate-50 ">
          <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8 text-slate-800 dark:text-slate-50">
            ...
            <p className="text-base leading-relaxed  mt-7 text-slate-800 dark:text-slate-50">
              Amet minim mollit non deserunt ullamco est sit aliqua dolor do
              amet sint. Velit officia consequat duis enim velit mollit.
            </p>

            <ul className="flex items-center space-x-3 mt-9 text-slate-800 dark:text-slate-50">
              <li>
                <Link
                  href="#"
                  title=""
            ...
            <ul className="mt-6 space-y-4">
              <li>
                <Link
                  href="#"
                  title=""
                  className="flex text-base  transition-all duration-200 text-slate-800 dark:text-slate-50"
                >
                  {' '}
                  Customer Support{' '}
                </Link>
        ...
        <p className="text-sm text-center text-slate-800 dark:text-slate-50">
